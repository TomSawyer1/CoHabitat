...
export default function Sidebar({ isSidebarVisible, onClose }: SidebarProps) {
  ...
  const menuItems = [
    { id: 1, text: 'Paramètres', icon: 'settings-outline', activeIcon: 'settings' },
    { id: 2, text: 'Mon Bâtiment', icon: 'business-outline', activeIcon: 'business' },
    { id: 3, text: 'Profil', icon: 'person-outline', activeIcon: 'person' },
    { id: 4, text: 'Déconnexion', icon: 'log-out-outline', activeIcon: 'log-out' },
  ];
